...
interface UserSource {
    ...
    fun createUser(userToAdd: UserRequestModel<User>, userAccount: UserRequestModel<Account>) : Completable

    fun checkIfUserExist(requestModel: UserRequestModel<Unit>) : Single<Boolean>

    fun checkIfUserHasAccountProvider(requestModel: UserRequestModel<String>) : Single<Boolean>
