...
fun ShoppingList.toListModel() : ListModel = ListModel(uuid, name, ownerName, usersShopping, lastChange)

fun ListModel.toList() : ShoppingList = ShoppingList(id, name, owner, usersShopping, lastChange)

fun ShoppingItem.toItemModel() : ItemModel = ItemModel(uuid, name, itemOf, count, price, bought, boughtBy, image.uri)

fun ItemModel.toItem() : ShoppingItem = ShoppingItem(id, name, itemOf, count, price, bought, boughtBy, ItemImage(image))