...
import com.dbeginc.dbshopping.di.qualifiers.AuthenticationUserRepo
...
class PresentationModule {
    ...
    @Provides
    internal fun provideLoginPresenter(@AuthenticationUserRepo userRepo: IUserRepo, @AuthenticationErrorManager authErrorManager: IErrorManager, @AuthenticationFieldValidator fieldValidator: IFormValidator) : LoginContract.LoginPresenter =
            LoginPresenterImpl(userRepo, authErrorManager, fieldValidator)

    @Provides
    internal fun provideSignUpPresenter(@AuthenticationUserRepo userRepo: IUserRepo, @AuthenticationErrorManager authErrorManager: IErrorManager, @AuthenticationFieldValidator fieldValidator: IFormValidator) : SignUpContract.SignUpPresenter =
