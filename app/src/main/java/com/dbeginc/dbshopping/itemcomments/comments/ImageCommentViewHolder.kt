...
import com.dbeginc.dbshopping.databinding.ImageCommentLayoutBinding
 ...
 *
 * Image comment viewHolder
 */
class ImageCommentViewHolder(private val binding: ImageCommentLayoutBinding, private val actionBridge: CommentActionBridge) : RecyclerView.ViewHolder(binding.root), CommentBridge {

    init {
        binding.imageComment.setOnClickListener {
            actionBridge.onImageExpandRequest(binding.comment!!)
        }
    ...
    fun bindImageComment(comment: CommentModel) {
