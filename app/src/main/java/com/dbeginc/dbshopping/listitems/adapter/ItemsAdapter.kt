 ...
 */
class ItemsAdapter(items: List<ItemModel>, val currentUserName: String, private val itemUpdateEvent: PublishSubject<ItemModel>) : RecyclerView.Adapter<ItemViewHolder>() {
