 ...
 */
class CheckIfUserExist(private val userRepo: IUserRepo) : UseCaseSingle<Boolean, UserRequestModel<Unit>>() {

    override fun buildUseCaseObservable(params: UserRequestModel<Unit>): Single<Boolean> =
            userRepo.doesUserExist(params)
