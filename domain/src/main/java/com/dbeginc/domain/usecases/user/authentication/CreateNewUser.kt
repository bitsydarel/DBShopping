 ...
 */
class CreateNewUser(private val userRepo: IUserRepo) : UseCaseCompletable<AuthRequestModel<String>>() {

    override fun buildUseCaseCompletableObservable(params: AuthRequestModel<String>): Completable =
            userRepo.createNewUser(params)
