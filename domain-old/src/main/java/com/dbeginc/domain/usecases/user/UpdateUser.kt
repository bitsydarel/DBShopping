 ...
 */
class UpdateUser(private val userRepo: IUserRepo) : UseCaseCompletable<UserRequestModel<User>>() {

    override fun buildUseCaseCompletableObservable(params: UserRequestModel<User>): Completable =
            userRepo.updateUser(params)
