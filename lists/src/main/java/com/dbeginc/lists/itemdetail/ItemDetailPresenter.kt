 ...
 */
class ItemDetailPresenter : MVPVPresenter<ItemDetailView> {
    override fun bind(view: ItemDetailView) = view.setupView()

    fun canRemoveCount(item: ItemModel): Boolean = item.count > 1
}